              ...
              <div class="box-body">
                ...
                <div class="form-group f-grid-col">
                  ...
                  <div class="control-group">
                    <input type="text" name="sohieu" value="{{$minhchung->sohieu}}" placeholder="H1-1-02-01" class="span8">
                  </div>
                </div>
                  <div class="form-group f-grid-col">
                    <label>Tên Tiêu chuẩn</label>
                    <div class="control-group">
                    <select name="tentieuchuan" value="{{$minhchung->tentieuchuan}}" onchange="chon();">
                      <option value="0">{{$minhchung->tentieuchuan}}</option> 
         ...
         <script type="text/javascript">
              ...
              function chon(){
                ...
                if(tentieuchuan!=0){
                  ...
                  document.formulariol.tentieuchi.options[0].value="{{$minhchung->tentieuchi}}";
                  document.formulariol.tentieuchi.options[0].text="{{$minhchung->tentieuchi}}";
                }
