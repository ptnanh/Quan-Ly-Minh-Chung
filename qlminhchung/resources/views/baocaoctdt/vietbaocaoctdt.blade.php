...
<style>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <form method="post" action="" name="formulariol">
              ...
              <div class="box-body">
                ...
                <div class="f-grid">
                 ...
                 <!--   <ul id="main-menu">
                        <li><label>Chọn tiêu chuẩn</label>
                            <ul class="sub-menu" id="main-menu1">
                                <li><input value="Tiêu chuẩn 1" name="tentieuchuan">
                                  <ul class="sub-menu1">
                                    <li>tiêu chí 1</li>
                                    <li>tiêu chí 2</li>
                                    <li>tiêu chí 3</li>
        ...
        <div class="form-group">
                    <label>Nhập tên chương trình đào tạo</label>
                    <div class="control-group kt">
                    <input type="text" name="tenctdt" class="form-control" placeholder="Nhập tên ctdt">
                  </div>
                  </div>
        <div class="row">
        <div class="col-md-12">
